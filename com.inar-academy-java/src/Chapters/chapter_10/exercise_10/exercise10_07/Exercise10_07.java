package Chapters.chapter_10.exercise_10.exercise10_07;
    ...
    public static void withDrawProcess(Account account, Scanner input) {
        ...
        while (0 > amount || amount > account.getBalance()) {
            if (amount < 0) {
                ...
                System.out.println("You don't have $" + amount + " in your account.Your balance is $" + account.getBalance() + ".Enter a reasonable amount :");
            }
